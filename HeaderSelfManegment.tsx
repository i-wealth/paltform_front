    ...
    <header className="bg-black text-white z-50 relative" dir="rtl">
      ...
      <div className="flex items-center py-4 px-6">
        ...
        <div className="flex items-center gap-4 ms-auto">
          ...
          <button className="bg-white text-black py-2 px-4 rounded-md hover:bg-gray-100 transition" onClick={() => handleClick("/login")} hidden={raw ? true : false}>
            ورود / ثبت‌نام
          </button>
        </div>
      </div>
      ...
      <div className="flex items-center justify-start gap-8 py-2 px-6 border-t border-gray-700">
        ...
        <Link href="/dashboard" className="text-white hover:text-blue-500 font-semibold transition">
          داشبورد من
        </Link>
      </div>
