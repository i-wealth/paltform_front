    ...
    <section className="bg-white py-16 px-6 md:px-16">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
          <button className="bg-yellow-400 text-white px-6 py-2 rounded-full text-lg shadow-md hover:shadow-lg transition-all duration-300">
            جستجوگر و آگاهانه برای درآمد حداکثری
          </button>
          <button className="bg-purple-600 text-white px-6 py-2 rounded-full text-lg shadow-md hover:shadow-lg transition-all duration-300">
            شروع سرمایه‌گذاری
          </button>
        </div>
