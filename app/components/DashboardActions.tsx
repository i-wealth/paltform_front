...
import WalletBalance2 from './WalletBalance2'
import ExchangeBox from './ExchangeBox'
import Giftgoldcoin from './Giftgoldcoin'
        ...
        <div className="modal-overlay">
          <div className="modal-container">
            ...
            <div className="modal-body">
              <AutoInvestment onClose={closeModal} />
            </div>
          </div>
        </div>
      )}
          ...
          <div className="modal-container">
            ...
            <div className="modal-body">
              <div className="wallet-info">
                <WalletBalance className="wallet-item" />
                <WalletBalance2 className="wallet-item" />
              </div>
            </div>
          </div>
        </div>
