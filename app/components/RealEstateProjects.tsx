...
const projectList: Project[] = [
  {
    id: 1,
    title: 'توکنایز سرقفلی مغازه   /  شماره ۸',
    location: 'استان تهران / تهران',
    status: 'درحال عرضه',
    ...
    <section className="bg-white py-10 px-4 md:px-12 min-h-screen" dir="rtl">
      ...
      <div className="text-center mb-12 max-w-2xl mx-auto">
        ...
        <p className="text-gray-600 text-sm md:text-base leading-relaxed">
          پروژه‌های ایران ولث پروژه‌های ساخت‌وساز است، بنابراین هرچه زودتر برای سرمایه‌گذاری اقدام کنید، سود بیشتری در انتهای پروژه عاید شما می‌شود.
          ...
          >
            ...
            <div className="p-4 space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="bg-blue-100 text-blue-800 text-xs font-medium px-3 py-0.5 rounded-full">ویلا</span>
              </div>
